 ...
 */
@Entity
public class IntraClassUser implements UserDetails {
    ...
    public IntraClassUser(String username, String password, String role) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IntraClassUser that)) return false;
